...
/* Forward externs for the slot-picker SceneDefs (defined in
 * src/menu/slot_picker.c) so OpszynsClick + HandleMainMenuClick can
 * dispatch into them. */
 ...
 *
 * Non-static so src/scene/scene_input.c can call it from the panel-
 * click router. */
