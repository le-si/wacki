...
/* in-memory image */
WackiSaveFile g_save;                          /* DAT_00455118 */

/* world-state default template (0x999 dwords = 0x2664 B) — RE'd as
 * DAT_004434F0. In a real port this is generated by reading the original. */
...
extern uint32_t  g_entity_state[0x11C];        /* DAT_00449D28 */
extern uint32_t  g_scene_snapshot[0x1E];       /* DAT_00443332 */
