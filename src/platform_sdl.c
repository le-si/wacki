...
int PlatformInit(int w, int h, const char *title)
{
     ...
     * magnes/drzwi sprite at mouse pos every frame (1:1 with original
     * DirectDraw build where the GDI cursor was hidden and FUN_004067C0
...
void PlatformPumpEvents(void)
{
    ...
    while (SDL_PollEvent(&ev)) {
        ...
        case SDL_TEXTINPUT:
             ...
             * and FUN_0040A960 only accepts space + '0'..'Z'). Drop UTF-8
